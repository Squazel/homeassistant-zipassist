...
Documentation for the ZipAssist CMMS Home Assistant integration.
...
- **Integration code:** `custom_components/zipassist/`
- **API exploration script:** `exploration/explore.py`
- **Tests:** `tests/`
